import nextBtnPic from "./images/next.png";
import backBtnPic from "./images/back.png";
    ...
    #loadBullets() {
        ...
        for (let x = 0; x < this.images.length; x++) {
            ...
            bullet.addEventListener("click", (event) => {
                ...
                this.#updateBullet();
                this.x = ((window.innerWidth / 2 - this.imageWidth / 2) - (this.index) * this.imageWidth);
                document.querySelector(".images-div").style.transform = `translateX(${this.x}px)`;
            });
